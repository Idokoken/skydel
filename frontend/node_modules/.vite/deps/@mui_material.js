...
import { $ as styled$2, A as createContainer, B as emphasize, C as lightBlue, Ct as deepmerge, D as purple, Dt as clsx, E as red, Et as composeClasses, F as useRtl, G as lighten, H as getLuminance, I as exactProp, J as clamp, K as recomposeColor, L as alpha, M as InitColorSchemeScript$1, N as ThemeProvider$1, O as grey, Ot as require_prop_types, P as useId, Q as resolveProps, R as darken, S as green, St as createBreakpoints, T as orange, U as hexToRgb, V as getContrastRatio, W as hslToRgb, X as useThemeProps$1, Y as useEnhancedEffect, Z as getThemeProps, _ as createTransitions, _t as getValue, a as rootShouldForwardProp, at as createTheme$1, b as createTypography, bt as mergeBreakpointsInOrder, c as useTheme, ct as require_jsx_runtime, d as createTheme, dt as CacheProvider, et as generateUtilityClasses, f as createThemeWithVars, ft as createCache, g as getOverlayAlpha, gt as createUnarySpacing, h as createColorScheme, ht as styleFunctionSx_default, i as styled, it as useTheme$2, j as createCssVarsProvider, k as common, l as identifier_default, lt as css, m as shouldSkipGeneratingVar, n as memoTheme, nt as ClassNameGenerator, o as slotShouldForwardProp, ot as createSpacing, p as excludeVariablesFromRoot, pt as StyleSheet, q as rgbToHex, r as globalCss, rt as useTheme$1, s as GlobalStyles, st as styled$1, t as useDefaultProps, tt as generateUtilityClass, u as defaultTheme$2, ut as keyframes, v as duration, vt as getPath, w as blue, wt as require_react_is, x as createMixins, xt as resolveBreakpointValues, y as easing, yt as handleBreakpoints, z as decomposeColor } from "./DefaultPropsProvider-Cl4Bkjyw.js";
import { t as capitalize_default } from "./capitalize-BwAswDwl.js";
import { A as debounce$1, C as ownerDocument_default, D as isMuiElement_default, E as activeElement, F as normalizedTransitionCallback, I as reflow, L as Transition, M as createChainedFunction, N as getTransitionChildStyle, O as deprecatedPropType_default, P as getTransitionProps, R as isMuiElement, S as ownerWindow, T as getActiveElement_default, _ as useEnhancedEffect_default, a as getPaperUtilityClass, b as requirePropFactory_default, c as Collapse, d as unstable_ClassNameGenerator, f as mergeSlotProps, g as useId_default, h as unsupportedProp_default, i as Paper, j as createChainedFunction_default, k as debounce_default, l as collapseClasses, m as useControlled, n as accordionClasses, o as paperClasses, p as useControlled_default, r as getAccordionUtilityClass, s as integerPropType, t as Accordion, u as getCollapseUtilityClass, v as setRef_default, w as ownerDocument, x as ownerWindow_default, y as setRef } from "./Accordion-C_jpCDaM.js";
import { i as svgIconClasses, n as SvgIcon, r as getSvgIconUtilityClass, t as createSvgIcon } from "./createSvgIcon-B3LqSrtv.js";
import { a as resolveComponentProps, c as useForkRef_default, d as useEventCallback, f as elementTypeAcceptingRef_default, i as extractEventHandlers, l as useForkRef, m as useTimeout, n as useSlot, o as appendOwnerState, p as Timeout, r as mergeSlotProps$1, s as isHostComponent, u as useEventCallback_default, y as chainPropTypes } from "./AccordionContext-C4-DvXeJ.js";
import { t as require_react_dom } from "./react-dom-d-rjAg1x.js";
import { a as buttonBaseClasses, c as touchRippleClasses, i as ButtonBase, l as isFocusVisible, n as accordionSummaryClasses, o as getButtonBaseUtilityClass, r as getAccordionSummaryUtilityClass, s as getTouchRippleUtilityClass, t as AccordionSummary, u as refType } from "./AccordionSummary-Gp1ubRjf.js";
import { n as accordionDetailsClasses, r as getAccordionDetailsUtilityClass, t as AccordionDetails } from "./AccordionDetails-CjUWsABu.js";
...
var Typography = /* @__PURE__ */ import_react.forwardRef(function Typography(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TypographyRoot, {
		...
		ref,
		className: clsx(useUtilityClasses$103(ownerState).root, className),
		...other,
		ownerState,
		style: {
...
var AppBar = /* @__PURE__ */ import_react.forwardRef(function AppBar(inProps, ref) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppBarRoot, {
		...
		ownerState,
		elevation: 4,
		className: clsx(useUtilityClasses$101(ownerState).root, className, position === "fixed" && "mui-fixed"),
		ref,
		...other
	});
});
